...
- **`lesson-shell.html`** — data: `{title, sections: [{heading, body, exercisePrompt?}]}`. Explanation blocks interleaved with optional inline exercise prompts (the interactive-textbook shape), conversation panel below.
